  ...
  <div>
    <div v-if="showModal" class="modal">
      ...
      <div class="modal-content">
        ...
        <p><span class="bold">Made with:</span> {{ project.tech }}</p>
        <p><span class="bold">Learned about:</span> {{ project.learned }}</p>
        <div class="project-buttons">
          ...
          <a class="button" target="blank" :href="project.source">
            Source Code
          </a>
        </div>
      </div>
    ...
    <div class="project-content">
      ...
      <div class="project-information">
        ...
        <div class="project-links">
          <a v-if="project.source" target="_blank" :href="project.source"
            ><svg
            ...
            >
              ...
              /></svg
          ></a>
          <a v-if="project.demo" target="_blank" :href="project.demo"
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
